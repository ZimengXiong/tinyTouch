...
class ReleasePipelineTests(unittest.TestCase):
    ...
    def test_tag_workflow_promotes_without_rebuilding(self):
        ...
        self.assertIn("TINYTOUCH_RELEASE_BUILD", build_script)
        ...
        self.assertIn("find \"$bundle\" -type f", build_script)
        installer = (ROOT / "docs" / "public" / "install.sh").read_text()
        self.assertLess(installer.index("tar -tzf"), installer.index("tar -C"))
